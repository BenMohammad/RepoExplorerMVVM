...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainActivityViewModel.getAllCachedProjects().observe(this, new Observer<List<ModelCachedGitHubProject>>() {
            @Override
            public void onChanged(@Nullable List<ModelCachedGitHubProject> cachedGitHubRepos) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.bookmarks) {
            ...
            intent.setData(Uri.parse("https://github.com/giantturtle/GitHubClient"));
            if(intent.resolveActivity(getPackageManager()) != null){
                startActivity(intent);
            }
        }
    ...
    @Override
    public void onRowClicked(ModelCachedGitHubProject cachedProject, MainAdapter.MainClickType mainClickType) {
